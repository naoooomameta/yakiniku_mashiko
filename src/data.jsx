  ...
  categories: [
    {
      ...
      items: [
        { name: "おすすめランチ（平日）", price: "1,000", note: "焼肉盛合せ・ライス・スープ付き" },
...
const FACILITY = [
  { label: "席数", value: "テーブル席（団体最大28名様まで）" },
  { label: "貸し切り", value: "ご相談承ります（お早めのご予約をお願いいたします）" },
  { label: "併設施設", value: "アドベンチャーヴィレッジ益子／甘味処 峠の茶屋" },
  { label: "バーベキュー", value: "BBQハウスは2名様よりご利用可能。施設利用料 3,000円（要予約）。お肉は、焼肉ましこの特製！お手頃価格にてご用意出来ます。" },
...
const VOICE = [
  {
    ...
    price: "1,200",
    quote:
      "看板の名がつくだけある、口どけのちがう一枚。最初の一口で「これが本命か」と分かる味。",
    by: "宇都宮から / 40代ご夫婦",
  },
  {
    category: "ランチ",
    ...
    price: "1,300",
    quote:
      "和風オニオンソースが想像以上に和牛と合う。子どもにも食べさせやすくて、ランチの定番に。",
    by: "益子町在住 / 家族4人",
  },
  {
    category: "焼肉",
    ...
    price: "1,300",
    quote:
      "タンの厚みに驚いた。最初の一枚はやっぱり塩で、ゆっくり焼くのが正解。",
    by: "真岡市から / 40代ご夫婦",
  },
  {
    category: "ランチ",
    ...
    price: "1,600",
    quote:
      "ザブトン・ハラミ・カルビが一度に味比べできる贅沢ランチ。父の誕生日にちょうどよい一皿。",
    by: "益子町在住 / 三世代6人",
  },
  {
    category: "サイド・ご飯",
    ...
    price: "750",
    quote:
      "野菜が主役になる焼肉屋さん。地のものってこういうことか、と肉の前に唸る。",
    by: "茂木町から / 30代ご夫婦",
  },
  {
    category: "ランチ",
    ...
    price: "1,000",
    quote:
      "アスレチックでひと遊びしたあと、煙の気にならない焼肉でひと休み。1,000円でこのボリュームは助かる。",
    by: "宇都宮から / 家族4人",
  },
];
